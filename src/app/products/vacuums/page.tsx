...
export const metadata: Metadata = {
  title: "Pool Vacuums",
  description: "Shop The Bottom Feeder cordless battery-powered pool vacuums. No hoses, no cords, no hassle.",
};

export default function VacuumsPage() {
  const products = getProductsByCategory("vacuums");
  const categoryInfo = CATEGORY_INFO.vacuums;
